...
const patients_types_1 = require("./patients.types");
...
const data = [
    {
        ...
        ssn: '090786-122X',
        gender: patients_types_1.Gender.MALE,
    ...
    },
    {
        ...
        ssn: '050174-432N',
        gender: patients_types_1.Gender.FEMALE,
...
// eslint-disable-next-line @typescript-eslint/no-explicit-any
const patients = data.map((data) => {
    return (0, patients_1.patientParser)(data);
});
